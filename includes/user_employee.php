...
<div class="table-responsive">
  <table class="table table-bordered nobottommargin">
	...
	$sql = "SELECT d1.id, d1.user_id, d2.name, d2.user_name, d2.password FROM res_user_company d1 LEFT OUTER JOIN res_user d2 ON(d1.user_id = d2.id) WHERE d1.status =0 AND d1.employee_id='".$rel_id."' ORDER BY d1.create_date ASC";
