...
<section id="page-title">
	...
	<div class="container clearfix">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" ><a href="<?php echo URL;?><?php echo $lang; ?>/payment"><?php echo __('Payments');?></a></li>
...
<section id="content">
	...
	<div class="content-wrap">
		...
		if($uri !='/' && $uri != '')
		{
			...
			if($id != "")
			{
				$sql = "SELECT d1.id, d1.payment_name FROM res_payment d1 WHERE d1.status =0 AND d1.id='".$id."'";
	...
	<script>
		...
		function saveLine()
		{
			...
			var _url = '<?php echo URL;?>includes/action.php?ac=savePayment';
			...
			loadPage('gotoTop', _url, function(status, message)
			{
				if(status== 0)
				{
					if(message == "OK")
					{
						document.location.href ='<?php echo URL;?><?php echo $lang; ?>/payment';
					}
					else{
						alert(message);
					}
