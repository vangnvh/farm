...
<section id="page-title">
	...
	<div class="container clearfix">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" ><a href="<?php echo URL;?><?php echo $lang; ?>/material"><?php echo __('Product');?></a></li>
		</ol>
	</div>
...
<section id="content">
	...
	<div class="content-wrap">
		...
		<div class="container clearfix">
				...
				<div class="row">
					<div class="col-sm-8">
						<a class="button button-3d nomargin" href="<?php echo URL;?><?php echo $lang; ?>/materialform/new" value="login"><?php echo __('New');?></a>
					</div>
					<div class="col-sm-4">
				  ...
				  <table class="table table-bordered nobottommargin">
					<thead>
					  <tr>
						...
						<th  nowrap="nowrap" width="60"><?php echo __('Code');?></th>
					...
					<?php
					$sql = "SELECT d1.id, d1.name, d1.code FROM product d1 WHERE d1.status =0 AND d1.type='MATERIAL' AND d1.company_id='".$LOGIN_COMPANY_ID."'";
					if($search != "")
					{
						$sql = $sql." AND ( d1.name ILIKE '%".str_replace("'", "''", $search)."%' OR  d1.code ILIKE '%".str_replace("'", "''", $search)."%')";
					}
					...
					<tbody>
					  <tr>
						...
						<td nowrap="nowrap" style="width:50px"><a href="<?php echo URL;?><?php echo $lang; ?>/materialform/edit/<?php echo $id; ?>"><?php echo __('Edit');?></a> / <a href="javascript:delLine('<?php echo $id; ?>')"><?php echo __('Delete');?></a></td>
	...
	<script>
		function delLine(id)
		{
			...
			var _url = '<?php echo URL;?>includes/action.php?ac=delMaterial';
			...
			loadPage('gotoTop', _url, function(status, message)
			{
				if(status== 0)
				{
					if(message == "OK")
					{
						...
						document.location.href ='<?php echo URL;?><?php echo $lang; ?>/material?p=<?php echo $p?>';
					}
					else{
						alert(message);
					}
		...
		function doSearch(p)
		{
			...
			document.location.href ='<?php echo URL;?><?php echo $lang; ?>/material?search=' + encodeURIComponent(search) + "&p=" + p;
		}
		function delRows()
		{
			var count = 0;
