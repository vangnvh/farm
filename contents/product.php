...
<section id="page-title">
	...
	<div class="container clearfix">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" ><a href="<?php echo URL;?><?php echo $lang; ?>/product"><?php echo __('Product');?></a></li>
		</ol>
	</div>
...
<section id="content">
	...
	<div class="content-wrap">
		...
		<div class="container clearfix">
				...
				<div class="row">
					<div class="col-sm-8">
						<a class="button button-3d nomargin" href="<?php echo URL;?><?php echo $lang; ?>/productform/new" value="login"><?php echo __('New');?></a>
					</div>
					<div class="col-sm-4">
				  ...
				  <table class="table table-bordered nobottommargin">
					<thead>
					  <tr>
						...
						<th  nowrap="nowrap" width="80"><?php echo __('Code');?></th>
					...
					<?php
					$sql = "SELECT d1.id, d1.code, d1.name FROM product d1 WHERE d1.status =0 AND d1.type='PRODUCT' AND d1.company_id='".$LOGIN_COMPANY_ID."'";
					if($search != "")
					{
					...
					<tbody>
						...
						<td nowrap="nowrap" style="width:50px"><a href="<?php echo URL;?><?php echo $lang; ?>/productform/edit/<?php echo $id; ?>"><?php echo __('Edit');?></a> / <a href="javascript:delLine('<?php echo $id; ?>')"><?php echo __('Delete');?></a></td>
	...
	<script>
		function delLine(id)
		{
			...
			var _url = '<?php echo URL;?>includes/action.php?ac=delProduct';
			...
			loadPage('gotoTop', _url, function(status, message)
			{
				if(status== 0)
				{
					if(message == "OK")
					{
						...
						document.location.href ='<?php echo URL;?><?php echo $lang; ?>/product?p=<?php echo $p?>';
					}
					else{
						alert(message);
					}
		...
		function doSearch(p)
		{
			...
			document.location.href ='<?php echo URL;?><?php echo $lang; ?>/product?search=' + encodeURIComponent(search) + "&p=" + p;
		}
		function delRows()
		{
			var count = 0;
